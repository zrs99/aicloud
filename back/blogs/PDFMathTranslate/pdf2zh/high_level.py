...
def translate(
    ...
    for file in files:
        ...
        # output_path = 'D:/Study/Code/AICloud/back/media/processed/'
        # file_mono = Path(output) / f"{filename}-mono.pdf"
        # file_dual = Path(output) / f"{filename}-dual.pdf"

        # from django.conf import settings
        # output_path = os.path.join(settings.BASE_DIR, 'media', 'processed')

        file_mono = os.path.join(save_path, f"{filename}-mono.pdf")
        file_dual = os.path.join(save_path, 'media', 'processed', f"{filename}-dual.pdf")
